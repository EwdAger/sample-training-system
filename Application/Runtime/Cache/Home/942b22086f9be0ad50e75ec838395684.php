...
<head>
    ...
    <![endif]-->
    <?php
 $index="\"".U('index/index',"")."\""; $actUrl="\"".U('Train/inpack_class_select',"")."\""; ?>
</head>
<body>
                    ...
                    <form class="form-horizontal" method="post" action=<?php echo $actUrl?>>
                        ...
                        <div class="form-group">
                            <div class="text-left">
                                <div class="alert alert-info">
                                    <p><b><?php echo ($data['name']); ?></b> 先生/女士你好! 请选择您想要培训的班级。<br/> 您目前的等级为<b><?php echo ($data['level']); ?></b>级
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="text-left" style="color: #000">
                                <label>
                                    <input type="radio" name="_class" value="管理">管理
                                </label>
                                <br>
                                <label>
                                    <input type="radio" name="_class" value="技术">技术
                                </label>
                                <br>
                                <label>
                                    <input type="radio" name="_class" value="销售">销售
                                </label>
